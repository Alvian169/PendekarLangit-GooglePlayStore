 ...
 * @version (1.0)
 */
public class Level5 extends Core
{
    Label label = new Label("LEVEL 5", 25);
    int x = 0, y = 0;
    boolean test = false;
    /**
    ...
    public void act()
    {
        ...
        {
            y=1;
            if(Level5.score.getValue()>HighScore)
            {
                HighScoreTemp+=Level5.score.getValue();
                HighScore=HighScoreTemp;
                highScore.setValue(HighScore);
            }
            yourScore.setValue(Level5.score.getValue());
    ...
    {
        Bug bug5 = new Bug(4);
        addObject(bug5, Greenfoot.getRandomNumber(700)+154, Greenfoot.getRandomNumber(480)+480);
    }
}
