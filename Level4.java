 ...
 * @version (1.0)
 */
public class Level4 extends Core
{
    Label label = new Label("LEVEL 4", 25);
    int x = 0, y = 0;
    boolean test = false;
    /**
    ...
    public void act()
    {
        ...
        {
            y=1;
            if(Level4.score.getValue()>HighScore)
            {
                HighScoreTemp+=Level4.score.getValue();
                HighScore=HighScoreTemp;
                highScore.setValue(HighScore);
            }
            yourScore.setValue(Level4.score.getValue());
    ...
    {
        Bug bug4 = new Bug(3);
        addObject(bug4, Greenfoot.getRandomNumber(700)+154, Greenfoot.getRandomNumber(480)+480);
    }
}
