 ...
 * @version (1.0)
 */
public class Level2 extends Core
{
    Label label = new Label("LEVEL 2", 25);
    int x = 0, y = 0;
    boolean test = false;
    /**
    ...
    public void act()
    {
        ...
        {
            y=1;
            if(Level2.score.getValue()>HighScore)
            {
                HighScoreTemp+=Level2.score.getValue();
                HighScore=HighScoreTemp;
                highScore.setValue(HighScore);
            }
            yourScore.setValue(Level2.score.getValue());
    ...
    {
        Bug bug2 = new Bug(1);
        addObject(bug2, Greenfoot.getRandomNumber(854)+854, Greenfoot.getRandomNumber(400)+40);
    }
}
